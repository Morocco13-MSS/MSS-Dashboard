...
class ChemoRCT extends Component {
    render() {
                ...
                <Panel.Body>
                    ...
                    <div className="square_bottom_pna">
                        <div className="chemoRTC_square_left_a">
                            ...
                            <div className="perforation_yes_value">{this.props.data.chemoOrRct}</div>
                        </div>
                        ...
                        <div className="chemoRTC_square_right">
