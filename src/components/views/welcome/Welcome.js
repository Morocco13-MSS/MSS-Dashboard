...
import { Navbar, Nav, NavItem, Grid, Row, Col, Glyphicon, NavDropdown, MenuItem, Media} from 'react-bootstrap';
                            ...
                            <div>
                                ...
                                <Media>
                                    <Media.Body>
                                        ...
                                        <ul className="noStyleList">
                                            <li className="justify"><span className="margin5R">1.</span>Patient de sexes masculin et féminin âgés de 16 ans et plus opéré pour  un cancer de localisation digestive, prouvé ou suspecté, à visée curative ou palliative</li>
                                            <ol className="justify"><span className="margin5R">1.</span>En situation élective: inclusion à partir de la programmation pour chirurgie</ol>
                                            <ol className="justify"><span className="margin5R">2.</span>En situation urgente: inclusion au plus tard 72 heures après la  chirurgie</ol>
                                            <li className="justify"><span className="margin5R">2.</span>Cancer prouvé ou suspecté dans les localisations digestives suivantes: colon, appendice, anus, rectum, oesophage, estomac, jonction oeso-gastrique, voies biliaires, ampoule de Vater, pancréas, duodénum,  intestin grêle et foie.</li>
                                            <li className="justify"><span className="margin5R">3.</span>Patient disposé et apte à donner son accord pour participer à l’étude.</li>
                                        </ul>
                                ...
                                <Media>
                                    <Media.Body>
                                        ...
                                        <ul className="noStyleList">
                                            <li className="justify "><span className="margin5R">1.</span>Patient dont l’intervention chirurgicale est indiquée pour:</li>
                                            <ol className="justify deco1List">
                                            ...
                                            <li className="justify"><span className="margin5R">2.</span>Patient dont l’intervention chirurgicale est indiquée pour une poursuite évolutive ou une récidive locale prouvée ou suspectée d’un cancer de localisation digestive ayant déjà fait l’objet d’une intervention chirurgicale (à l’exception des situations d’hépatectomie itérative pour métastase hépatique et de reprise du lit tumoral après découverte d’un cancer vésiculaire sur pièce de cholécystectomie).
                                            </li>
                                            <li className="justify"><span className="margin5R">3.</span>Patients dont l’intervention est à visée diagnostique sans aucune intention curative ou palliative</li>
                                            <li className="justify"><span className="margin5R">4.</span>Patients dont l’intervention chirurgicale est une transplantation hépatique.</li>
                                            <li className="justify"><span className="margin5R">5.</span>Patients dont l’intervention chirurgicale est une destruction locale (radiofréquence, micro-ondes) par voie percutanée exclusive (sans laparotomie ou laparoscopie).</li>
